...
# сделать функцию рисования ветки из заданной точки, заданной длины с заданным наклоном
...
next_length = next_length * .75
next_point = branch(point=next_point, angle=next_angle, length=next_length)
# написать цикл рисования ветвей с постоянным уменьшением длины на 25%
# и отклонением на 30 градусов
